...
internal class TimeZoneDataSeeder : NoxReferenceDataSeederBase<WorldDbContext, Models.TimeZones.TimeZoneInfo, TimeZone>
{
    ...
    protected override IEnumerable<Models.TimeZones.TimeZoneInfo> GetDataInfos()
    {
