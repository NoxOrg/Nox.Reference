...
public class CliCommandExecutor : ICliCommandExecutor
{
    ...
    private readonly EnviromentSetupCommand _envSetupCommand;
    ...
    public CliCommandExecutor(
        ...
        EnviromentSetupCommand envSetupCommand,
    ...
    {
        _logger = logger;
        _envSetupCommand = envSetupCommand;
